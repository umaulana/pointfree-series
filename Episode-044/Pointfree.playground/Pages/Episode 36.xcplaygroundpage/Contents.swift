...
extension Equating where A == String {
    static let string = Equating(equals: ==)
}
...
Equating.array(of: .string).equals(["asdf"], ["asdf2"])
...
Equating.tuple(.int, .string).equals((1, "Blob"), (1, "Blob"))
Equating.tuple(.int, .string).equals((1, "Blob"), (1, "Blob Jr"))
Equating.tuple(.int, .string).equals((1, "Blob"), (2, "Bolb"))
...
RawRepresenting<Directions, String>.rawRepresentable.convert("D")
